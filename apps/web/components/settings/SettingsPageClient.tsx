...
import type { ClockFormat, MementoEntryRow, ProfileRow, QuoteStyle, ThemeMode } from "@focal/shared";
...
type Section = "general" | "account" | "focus" | "memento" | "calendar" | "help";
...
function AccountSection({
  ...
  const sendReset = async () => {
    ...
    const { error } = await supabase.auth.resetPasswordForEmail(email, { redirectTo: `${origin}/settings` });
    if (error) onError(error.message);
